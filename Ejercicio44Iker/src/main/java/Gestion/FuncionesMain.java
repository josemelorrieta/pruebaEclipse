...
public class FuncionesMain {
	...
	public void ProcesarDatos(Alumno[] alumnos, FuncionesAlumnos funcAlumnos) {
		// Declaracion e inicializacion de variables
		float promedio = 0;
		int contadorPersonas = 0;
		//Inicio de programa
		promedio = funcAlumnos.CalcularPromedio(alumnos);
		contadorPersonas = funcAlumnos.CalcularTotal(alumnos);
